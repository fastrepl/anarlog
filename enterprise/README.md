# BlackMushi Enterprise

This directory contains source-visible, commercially licensed BlackMushi Enterprise components. It is part of the BlackMushi monorepo but is not licensed under the repository's MIT License. See [LICENSE](LICENSE) and the repository's [licensing boundary](../LICENSING.md).
