...
## Can I export notes in Org mode format?

Yes. In addition to PDF and VTT, Char supports exporting session data as Org mode (`.org`) files. This is useful if you work in Emacs or other editors that support the Org format.

## Does Char support Google Calendar?

Yes. Char supports syncing with Google Calendar in addition to Apple Calendar. Go to **Settings** > **Calendar** to connect your Google account. Once connected, upcoming events appear in the sidebar timeline and calendar views, and you can create sessions linked to calendar events.

## Can the AI chat edit my notes?

Yes. The AI chat includes an edit tool that can make changes to your notes directly during a conversation. When the chat suggests edits, they are applied to your note content.
