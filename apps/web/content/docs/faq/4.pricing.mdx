...
**Char Pro** is $25/month (or $250/year) and includes everything in Lite plus playback rate controls, custom instructions, integrations, cloud sync, and shareable links.
