...
If you see repeated password prompts asking for access to keychain items like `com.char.Argmax.licenseToken` or similar entries, this is typically caused by outdated or corrupted keychain entries from a previous version of Char.
...
2. In the search bar, type `char` or `argmax`
