...
# or manually (macOS)
cp -r examples/plugins/my-plugin ~/Library/Application\ Support/com.char.dev/plugins/

# Linux
cp -r examples/plugins/my-plugin ~/.local/share/com.char.dev/plugins/

# Windows
cp -r examples/plugins/my-plugin %APPDATA%/com.char.dev/plugins/
```
