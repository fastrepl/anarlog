...
```bash
C:\Users\[username]\AppData\Local\char\logs
```

### Linux

```bash
~/.local/share/char/logs/
```
...
```bash
~/Library/Application Support/char/
...
```bash
C:\Users\[username]\AppData\Local\char\
```
...
- Join our [Discord community](https://discord.gg/char)
