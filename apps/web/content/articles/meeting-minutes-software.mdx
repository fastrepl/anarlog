...
| Anarlog           | Control over data and AI stack | Free (OSS, local + BYOK). Managed cloud: [Char](https://char.com)     |
...
![Anarlog (foremly Anarlog)](/api/assets/blog/blog/anarlog-summary.png)
