...
| --------- | -------------------------------------------------------- | ------------------------------------------------- | ------------------------------------------------ |
| Anarlog  | Zero lock-in, complete control over data and AI stack    | Free forever, fully local + BYOK. (Managed cloud: see [Char](https://char.com))        | All platforms (system audio capture) + in-person |
...
Anarlog is free forever, fully local, BYOK, and open source. If you want a managed cloud version with sync and integrations, see [Char](https://char.com). (Enterprise needs like on-prem and SSO are handled via [Char](https://char.com).)
