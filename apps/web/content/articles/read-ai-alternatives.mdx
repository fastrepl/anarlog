...
But the breadth is also why people leave. Most users came to Read AI for meeting notes and ended up paying for email summaries, a Slack integration, and an AI assistant they never asked for. And then there's the bot: Read AI joins every call as a visible participant, spreads through organizations via OAuth, and records people who never consented. 
