...
- **Your choice of AI stack** - use a managed cloud option (see [Char](https://char.com)), bring your own API keys (OpenAI, Anthropic, Deepgram), or run fully local via Ollama or LM Studio
