...
*OpenAI-provided training-control example, shown at its native 400-pixel width. This is not a screenshot of our signed-in account. Source: [official Chatgpt documentation](https://help.openai.com/en/articles/7730893-data-controls-faq), checked September 22, 2026. [Open full-size image](https://ijoptyyjrfqwaqhyxkxj.supabase.co/storage/v1/object/public/blog/library/products/chatgpt/privacy/2026-09-22-training-control.png).*
...
*Historical vendor illustration from the August 28, 2025 announcement, showing the September 28, 2025 policy rollout. It is not a 2026 account-settings capture; the current rules are sourced separately in the table. Source: [official Claude documentation](https://www.anthropic.com/news/updates-to-our-consumer-terms), checked September 22, 2026. [Open full-size image](https://ijoptyyjrfqwaqhyxkxj.supabase.co/storage/v1/object/public/blog/library/products/claude/privacy/2026-09-22-vendor-opt-in-notice-2025.png).*
...
*Google-provided mobile illustration from August 13, 2025. Current retention claims come from the separately linked Privacy Hub. Source: [official Gemini documentation](https://blog.google/products-and-platforms/products/gemini/temporary-chats-privacy-controls/), checked September 22, 2026. [Open full-size image](https://ijoptyyjrfqwaqhyxkxj.supabase.co/storage/v1/object/public/blog/library/products/gemini/privacy/2026-09-22-keep-activity.webp).*
