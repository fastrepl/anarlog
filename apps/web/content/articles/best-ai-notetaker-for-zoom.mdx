...
[Anarlog](/) is an open-source AI notepad for meetings built for high-agency people who demand complete control. Everything is stored as plain markdown files on your device—not in proprietary databases. You choose your AI: bring your own keys or run local models. (For a managed cloud option, see [Char](https://char.com).)
...
- Your choice of AI stack: bring your own keys or run local. (For a managed cloud option, see [Char](https://char.com).)
...
For enterprise needs (on-prem, SSO, compliance), [Char](https://char.com) offers a managed enterprise plan.
