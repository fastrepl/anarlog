...
![Anarlog Settings → Intelligence with Mistral selected and an API key entered](https://ijoptyyjrfqwaqhyxkxj.supabase.co/storage/v1/object/public/blog/library/products/anarlog/desktop/2026-09-23-settings-intelligence-mistral.png)

*Paste your key under Settings → Intelligence → Mistral, then pick a Mistral model as the one being used.*
...
To connect Mistral, open Anarlog's settings, go to Intelligence, pick Mistral, paste your key, and that's it. Try it out for free now - [Download Anarlog](https://anarlog.so/download/).
