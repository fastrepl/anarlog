...
Free forever for local transcription, BYOK, and all core features. (For a managed cloud option with the easiest setup, see [Char](https://char.com).)

For enterprise needs (on-premises deployment, SSO integration, consent management, custom branding), [Char](https://char.com) offers a managed enterprise plan.
