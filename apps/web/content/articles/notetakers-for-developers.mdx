...
| ------------------------ | ------------------------------------------------------ | -------------------------------------- |
| Anarlog | AI meeting notes with local files and your own LLM | Free forever (OSS, local + BYOK). |
...
Free with no limits if you bring your own API key or run local models. For a developer running Ollama locally, the free tier is genuinely unlimited.
