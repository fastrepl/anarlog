...
[Hyprnote](https://char.com) (renamed to Char in March 2025) and [Meetily](https://meetily.ai) were both created in December 2024. Both are written in Rust. Both capture system audio without a bot. Both are open-source and local-first. 
...
[Char is GPL-3.0 licensed](https://github.com/fastrepl/char). [Meetily is MIT](https://github.com/Zackriya-Solutions/meetily).
