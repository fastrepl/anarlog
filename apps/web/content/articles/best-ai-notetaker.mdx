...
| ------------- | ----------------------------------- | ------------------------------------- | ------------------------------------------ |
| Anarlog | macOS | Zero lock-in, complete control | Free forever, fully local + BYOK. |
...
Anarlog exists because of that. It's an open-source AI notepad for meetings that stores everything as plain markdown files on your device. Zero lock-in. You choose your AI: bring your own API keys or run local models. No bots. No vendor dependency.
