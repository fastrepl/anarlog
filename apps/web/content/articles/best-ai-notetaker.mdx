...
| ------------- | ----------------------------------- | ------------------------------------- | ------------------------------------------ |
| Anarlog      | macOS                               | Zero lock-in, complete control        | Free forever, fully local + BYOK. (Managed cloud: see [Char](https://char.com))  |
...
Anarlog exists because of that. It's an open-source AI notepad for meetings that stores everything as plain markdown files on your device. Zero lock-in. You choose your AI: bring your own API keys or run local models. (For a managed cloud option, see [Char](https://char.com).) No bots. No vendor dependency.
