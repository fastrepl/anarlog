...
- **AI Summarization** — use your own API keys (OpenAI, Anthropic, and others) or run local models via Ollama or LM Studio (or use a managed cloud option via [Char](https://char.com))
