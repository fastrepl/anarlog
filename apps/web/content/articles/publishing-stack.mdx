---
meta_title: "Anarlog's Publishing Stack: MDX, GitHub, and the Future of Docs"
display_title: "How We Built Anarlog's Publishing Stack"
meta_description: "A deep dive into how Anarlog built a future-proof publishing system using MDX, GitHub workflows, custom components, and TanStack Start—and why this approach outlives most CMS platforms."
author: "John Jeong"
...
When we looked at the options — WYSIWYG editors, headless CMS platforms, Git-based CMS layers, hosted docs systems — every option either slowed us down or boxed us in. So we did the simplest thing: we built our publishing system the same way we build Anarlog.
...
6. [How We Built Anarlog's Publishing Stack](/blog/publishing-stack) (You are here)
