...
We're building our docs on TanStack Start + MDX, with a GitHub PR workflow, custom MDX components (callouts, tabs, code demos), automatic TOC + search, Keystatic as our team grows, and future interactive "live notebooks" tied to Anarlog.
