...
| ------------ | ----------------------- | ------------------------------------------------------------------ | ------------------------------------------------- |
| Anarlog     | Zero lock-in, complete control | Free forever, fully local + BYOK. (Managed cloud: see [Char](https://char.com))nth. | Open source. Plain markdown files. Your choice of AI. |
