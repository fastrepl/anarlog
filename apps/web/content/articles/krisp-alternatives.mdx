...
[Char](char.com) is open-source and built on a different set of assumptions than everything else on this list. It captures system audio without joining your call and without requiring calendar permissions, then stores everything as plain markdown files on your device. Not in a proprietary database. Not on someone else's server. Markdown files, in a folder, on your computer.
