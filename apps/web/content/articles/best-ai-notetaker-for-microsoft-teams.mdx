...
Anarlog is [free forever](/blog/free-ai-notetakers) for local transcription, BYOK, and all core features. For a managed cloud version, see [Char](https://char.com). For enterprise needs (on-prem, SSO, consent management, compliance), [Char](https://char.com) offers a managed enterprise plan.
