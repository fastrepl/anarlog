...
Anarlog works differently. You decide how your data is processed — [local models on your device](/blog/local-ai-meeting-notes/) or your own cloud API keys (or a managed cloud option via [Char](https://char.com)). Everything saves as plain markdown files on your device, and IT teams can audit the open-source code. When you control the stack, you control the compliance surface.
