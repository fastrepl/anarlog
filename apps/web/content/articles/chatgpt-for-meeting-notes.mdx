...
Anarlog is an open-source AI notepad for meetings that gives you complete control over your data and AI stack. Everything is stored as plain markdown files. You choose your AI: managed cloud, bring your own keys, or run local models. Zero lock-in, zero compromises.
...
Also, Anarlog is free forever for local transcription, BYOK, and all core features. The managed cloud service is $25/month for the easiest setup.
