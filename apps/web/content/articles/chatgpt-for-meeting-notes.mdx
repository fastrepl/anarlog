...
Anarlog is an open-source AI notepad for meetings that gives you complete control over your data and AI stack. Everything is stored as plain markdown files. You choose your AI: bring your own keys or run local models. (For a managed cloud option, see [Char](https://char.com).) Zero lock-in, zero compromises.
...
Also, Anarlog is free forever, fully local, BYOK, and open source. If you want a managed cloud version with sync and integrations, see [Char](https://char.com).
