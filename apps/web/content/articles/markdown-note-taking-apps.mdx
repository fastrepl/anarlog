...
| Anarlog     | Meeting notes                  | ✅               | ✅               | Free (OSS, local + BYOK). Managed cloud: [Char](https://char.com)     |
...
- Your choice of AI stack - Use a managed cloud option (see [Char](https://char.com)), bring your own API keys (OpenAI, Anthropic, Deepgram, others), or run fully local via Ollama or LM Studio
...
Free forever, fully local + BYOK, open source. (For a managed cloud option, see [Char](https://char.com).)
