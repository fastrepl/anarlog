...
- Your choice of AI stack - Use a managed cloud option, bring your own API keys (OpenAI, Anthropic, Deepgram, others), or run fully local via Ollama or LM Studio
...
Free forever, fully local + BYOK, open source.
