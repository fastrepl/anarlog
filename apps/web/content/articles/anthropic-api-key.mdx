---
meta_title: "How to Get Your Anthropic API Key?"
meta_description: "Learn how to get an Anthropic API key, understand the tier system and rate limits, compare Claude model pricing, and start building with Claude today."
author:
  - "John Jeong"
featured: false
category: "Guides"
...
If a credit card upfront is a dealbreaker, [Mistral's Experiment plan](https://char.com/blog/mistral-api-key/) lets you get an API key with just a phone number. But if you want Claude specifically, this is the only path.

## How to generate your Anthropic API key (step by step)

![](https://auth.hyprnote.com/storage/v1/object/public/blog/blog/anthropic-api-key.gif "char-editor-width=80")
