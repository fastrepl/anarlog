...
| **Anarlog**       | Users who want complete control over data and AI stack             | Free forever (OSS, local + BYOK). (Managed cloud: see [Char](https://char.com))  |
...
The AI stack is yours to choose: a managed cloud option (see [Char](https://char.com)), your own API keys from OpenAI, Anthropic, or Deepgram, or fully local models through Ollama or LM Studio for offline operation. Every audio file, transcript, and note lives on your computer. You decide if data ever leaves your device.
...
Free for unlimited loacl transcription and AI. For a managed cloud option with sync, integrations, and advanced templates, see [Char](https://char.com).
