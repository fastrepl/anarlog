...
**Your choice of AI stack.** Anarlog works fully offline out of the box, but you're not locked into local-only. Bring your own API keys (OpenAI, Anthropic, Mistral, and others), or run local models via Ollama or LM Studio. Switch anytime. No lock-in.
