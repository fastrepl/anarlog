...
![Anarlog Settings → Transcription on macOS with the speech-to-text providers you can configure](https://ijoptyyjrfqwaqhyxkxj.supabase.co/storage/v1/object/public/blog/library/products/anarlog/desktop/2026-09-23-settings-transcription.png)

*Anarlog lets you choose the transcription model in Settings → Transcription.*
