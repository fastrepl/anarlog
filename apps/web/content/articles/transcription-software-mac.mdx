...
[Anarlog](/) is an open-source AI notepad for meetings built for Mac. Everything is stored as plain markdown files on your device. You choose your AI: bring your own keys or run local models. (For a managed cloud option, see [Char](https://char.com).) Zero lock-in.
