...
| [Anarlog](https://anarlog.so) | Zero lock-in, complete control    | Free forever, fully local + BYOK. (Managed cloud: see [Char](https://char.com))     | Open source. Plain markdown. Your choice of AI. |
...
Anarlog is the best Otter AI alternative if you want zero lock-in and complete control. It's an open-source AI notepad that stores everything as plain markdown files and lets you choose your AI: bring your own keys or run local models (or a managed cloud option via [Char](https://char.com)). Zero vendor lock-in, zero compromises.
