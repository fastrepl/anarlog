...
At [Anarlog](/), we're building an open-source AI notepad for meetings that gives you complete control. Everything is stored as plain markdown files. You choose your AI: bring your own keys or run local models. (For a managed cloud option, see [Char](https://char.com).) Zero lock-in, zero compromises.
