...
[Anarlog](/) is an open-source AI notepad for meetings that gives you complete control over your data and AI stack. Everything is stored as plain markdown files—not in proprietary databases. You choose your AI: bring your own keys or run local models. (For a managed cloud option, see [Char](https://char.com).)
