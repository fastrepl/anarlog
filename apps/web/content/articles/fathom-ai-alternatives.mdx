...
| --------- | -------------------------------------------------- | ------------------------------- |
| Anarlog | Zero lock-in, complete control | Free forever, fully local + BYOK. |
...
Free forever for local transcription, BYOK, and all core features. No usage caps, no artificial limits. Enterprise pricing covers on-prem deployment, smart consent management, and SSO—[contact sales for a quote](https://char.com).
