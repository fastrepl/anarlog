...
| --------- | -------------------------------------------------- | ------------------------------- |
| Anarlog  | Zero lock-in, complete control                     | Free forever, fully local + BYOK. (Managed cloud: see [Char](https://char.com)) |
...
Anarlog is an open-source AI notepad for meetings. Everything is stored as plain markdown files on your device—not in proprietary databases. You choose which AI processes your data: bring your own API keys or run local models. (For a managed cloud option, see [Char](https://char.com).)
...
Free forever for local transcription, BYOK, and all core features. No usage caps, no artificial limits. For a managed cloud version, see [Char](https://char.com). Enterprise pricing covers on-prem deployment, smart consent management, and SSO—[contact sales for a quote](https://char.com).
