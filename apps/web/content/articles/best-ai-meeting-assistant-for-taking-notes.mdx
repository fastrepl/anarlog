...
If you want the second option, Anarlog is the outlier here. Your meetings become files. You choose the AI layer. You can run fully local or use your own keys without rebuilding your workflow around a proprietary format.
