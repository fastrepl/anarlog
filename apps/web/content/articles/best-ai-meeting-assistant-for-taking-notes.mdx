...
Everything is stored as plain markdown files—not in proprietary databases. You choose your AI: bring your own keys or run local models. (For a managed cloud option, see [Char](https://char.com).)

<Image src="/api/assets/blog/best-ai-meeting-assistant-for-taking-notes/anarlog-app-mock.jpg" alt="Anarlog app mockup"/>
...
Anarlog is free forever, fully local, BYOK, and open source. If you want a managed cloud version with sync and integrations, see [Char](https://char.com). (Enterprise needs like on-prem, SSO, and admin controls are handled via [Char](https://char.com).)
...
If you want the second option, Anarlog is the outlier here. Your meetings become files. You choose the AI layer. You can run fully local or use your own keys without rebuilding your workflow around a proprietary format. (For a managed cloud option, see [Char](https://char.com).)

[**Download Anarlog for macOS**](https://anarlog.so) if that is the kind of setup you want to keep long term.
