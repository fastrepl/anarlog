...
![Anarlog](/api/assets/blog/open-source-meeting-transcription-software/anarlog.webp)
...
Free forever for local transcription, BYOK, and all core features. For a managed cloud version, see [Char](https://char.com). Enterprise offers on-premises deployment.
...
Ready to try it? [Download Anarlog for macOS](https://anarlog.so) or [check out the source code on GitHub](https://github.com/fastrepl/anarlog).

## Frequently asked questions

### 1. Are open-source transcription tools really free?

Yes, all three are open source. Anarlog and Amical are [free](/blog/free-transcription-software/) for all users. Anarlog is free forever for local transcription and BYOK. For a managed cloud version, see [Char](https://char.com).
