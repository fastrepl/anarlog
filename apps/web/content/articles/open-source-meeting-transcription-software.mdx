...
Free forever for local transcription, BYOK, and all core features. Enterprise offers on-premises deployment.
...
Yes, all three are open source. Anarlog and Amical are [free](/blog/free-transcription-software/) for all users. Anarlog is free forever for local transcription and BYOK.
