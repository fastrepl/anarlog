...
| ------------ | --------------------------------------------- | ----------------------------------------- | --------- |
| Anarlog         | Data ownership, privacy, offline use          | Free, fully local + BYOK. (Managed cloud: see [Char](https://char.com))        | Yes       |
...
tl;dv Pro is $29/month. Anarlog is free forever for local transcription and BYOK. For a managed cloud option, see [Char](https://char.com). If you left tl;dv over pricing or privacy, the gap here is still meaningful.
