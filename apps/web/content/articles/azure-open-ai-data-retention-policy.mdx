...
If your organization has a Modified Abuse Monitoring or ZDR agreement in place, those protections apply to requests routed through Char as well. Your notes are stored as plain markdown files on your device regardless of which provider processes them.