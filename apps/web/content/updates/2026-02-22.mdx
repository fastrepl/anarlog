...
Contact avatars now fall back to colored initials, telemetry opt-out now properly disables analytics, and the remaining Char references in the UI were updated to Char.
