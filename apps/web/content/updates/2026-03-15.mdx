...
This release also carries the Char-to-Char rename through the stable app. Existing users can update without changing how they work, and the app now consistently presents itself as Char.
