...
- **`download_clicked`** — `platform`, `spec`, `source`, optional `download_intent_id`
...
- `desktop_download_authenticated` — connects a tracked download click to desktop auth with `download_intent_id`
