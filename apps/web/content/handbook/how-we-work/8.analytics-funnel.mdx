...
Standard consented website analytics tracking, plus PostHog pageview and session tracking. UTM parameters on inbound links are automatically captured by PostHog as session properties.
