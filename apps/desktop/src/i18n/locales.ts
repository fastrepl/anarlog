...
export function resolveDisplayLocale(
  ...
  const menuLanguageCode = languageCode === "jw" ? "jv" : languageCode;
  if (menuLanguageCode && supportedDisplayLocales.has(menuLanguageCode)) {
    return menuLanguageCode as DisplayLocale;
  }
