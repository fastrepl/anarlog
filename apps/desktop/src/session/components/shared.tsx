...
export function RecordingIcon() {
  return (
    <span className="relative flex size-3 items-center justify-center">
      <span className="shape-circle absolute size-2.5 animate-ping rounded-full bg-red-500/40" />
      <span className="shape-circle relative size-2 rounded-full bg-red-500" />
    </span>
  );
}
