  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-2">
        <PermissionBlock
          enabledLabel={t`BlackMushi can hear your voice`}
          enableLabel={t`Help BlackMushi listen to you`}
        ...
        <PermissionBlock
          enabledLabel={t`BlackMushi can hear others`}
          enableLabel={t`Help BlackMushi listen to others`}
        ...
        {accessibility && (
          <PermissionBlock
            enabledLabel={t`BlackMushi can read meeting details`}
            enableLabel={t`Help BlackMushi read meeting activity`}
            enabledBody={t`Meeting details access turned on`}
            enableBody={
              accessibilityGuidance
                ? t`Opens System Settings and guides you to add BlackMushi to the ${accessibilityGuidance.paneTitle ?? "Privacy"} list`
