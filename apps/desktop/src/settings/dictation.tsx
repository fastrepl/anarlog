      ...
      <div className="flex flex-col gap-6">
        ...
        <SettingSwitchRow
          ...
          description={
            <Trans>
              ...
              connection to your selected transcription provider when supported.
              Text is inserted when you finish.
            </Trans>
          }
          checked={livePreview}
        ...
        <p className="text-muted-foreground text-xs">
          {platform() === "linux" ? (
            <Trans>
              ...
              Control + Alt + Escape to cancel. On X11, press Escape to cancel.
              The target app must expose an editable accessibility field.
            </Trans>
          ) : (
            <Trans>
        ...
        <p className="text-muted-foreground text-xs">
          <Trans>
            ...
            and dictionary. Temporary audio is deleted after transcription. Your
            last transcript stays in memory until dictation is disabled or
            BlackMushi closes.
          </Trans>
        </p>
