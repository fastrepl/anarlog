...
function useSettingsForm() {
  ...
  const form = useForm({
    defaultValues: {
      ...
      auto_disclose_recording: value.auto_disclose_recording,
    ...
    onSubmit: ({ value }) => {
      ...
      void analyticsCommands.event({
        ...
        auto_disclose_recording: normalizedValue.auto_disclose_recording,
            ...
            {(autoStartScheduledMeetingsField) => (
              <form.Field name="auto_stop_meetings">
                {(autoStopMeetingsField) => (
                  <form.Field name="auto_disclose_recording">
                    {(autoDiscloseRecordingField) => (
                            ...
                            {(telemetryConsentField) => (
                              <AppSettingsView
                                ...
                                autoDiscloseRecording={{
                                  title: t`Disclose recording in chat`,
                                  description: t`When listening starts, post a short recording notice in Zoom, Google Meet, or Microsoft Teams chat.`,
                                  value: autoDiscloseRecordingField.state.value,
                                  onChange: (val) =>
                                    autoDiscloseRecordingField.handleChange(
                                      val,
                                    ),
                                }}
                                floatingBar={{
