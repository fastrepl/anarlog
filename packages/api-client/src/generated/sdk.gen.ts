...
export const crmSearchContacts = <ThrowOnError extends boolean = false>(options: Options<CrmSearchContactsData, ThrowOnError>) => (options.client ?? client).post<CrmSearchContactsResponses, CrmSearchContactsErrors, ThrowOnError>({
