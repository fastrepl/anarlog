...
`Anarlog Cloud` is a separate MCP-only plugin for ChatGPT and Codex. It connects to the hosted server with OAuth and does not run the local CLI or bundle the skill.
