...
description: "Where security, legal, and IT teams can review BlackMushi's data handling, processors, and evaluation path."
---

Enterprise buyers should start at the [BlackMushi security page](https://anarlog.so/security). It is the public security-review packet: architecture, encryption, data location, retention, training policy, subprocessors, incident reporting, and the contracts we can send today.
...
- BlackMushi does not add a bot to Zoom, Google Meet, or Microsoft Teams.
...
- Data Processing Addendum: email [team@fastrepl.com](mailto:team@fastrepl.com?subject=BlackMushi%20DPA)
