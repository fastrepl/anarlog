...
Sharing publishes a meeting's generated summary so other people can review it without receiving your private memo. Sharing requires BlackMushi Pro, an account, and an internet connection.
...
For meetings with attendee email addresses, BlackMushi lists those people under **Suggested attendees**. They do not have access yet.
...
There is no global switch for sharing emails because BlackMushi does not send them automatically. If you open or close the panel without submitting **Invite** or **Email**, nothing is sent.
...
- **Everyone in your workspace** makes the note available to members of the selected BlackMushi workspace.
...
Check [Audio file retention](/data-and-privacy#choose-how-long-audio-is-kept) if the option is missing. BlackMushi cannot share audio that has already been removed from local storage.
...
See [Data, privacy, and retention](/data-and-privacy) for what sharing sends to BlackMushi's hosted service.
