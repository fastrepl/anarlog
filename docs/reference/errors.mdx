...
description: "Interpret CLI failures and recover without modifying BlackMushi storage."
---
...
| `3` | Database file not found | Open BlackMushi once to create it, or provide the correct database path. |
