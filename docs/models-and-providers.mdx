...
You can also connect a subscription for Intelligence instead of an API key: **ChatGPT**, **Grok**, **GitHub Copilot**, or **Kimi Code**. Open **Settings → Intelligence → Configure Providers** and use **Connect**.
