...
Recent bring-your-own Intelligence providers include **Venice**, configured with a Venice API key, and **Meta Muse** (`muse-spark-1.3` and the other `muse-spark` models), configured with a Meta Model API key.
