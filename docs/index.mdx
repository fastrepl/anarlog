...
BlackMushi records your microphone and computer audio without joining the call as a bot. Each meeting stays together as an editable memo, transcript, and summary.

<CardGroup cols={2}>
  <Card title="Try your first meeting" icon="play" href="/quickstart">
    Use the private demo in BlackMushi, then record a real meeting.
  </Card>
  ...
  <Card title="Choose your AI" icon="sparkles" href="/ai-setup">
    Use BlackMushi Cloud, your own provider, or local models.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="What languages does BlackMushi support?" icon="language" href="/help#supported-languages">
  ...
  <Card title="How do I compare transcription costs?" icon="coins" href="/help#compare-transcription-costs">
    See on-device, BlackMushi Cloud, and bring-your-own-key pricing.
  </Card>
  <Card title="How can I use on-device models?" icon="hard-drive" href="/help#use-on-device-models">
    Use Soniqo, Apple Speech, a whisper.cpp `.bin`, or a Deepgram-compatible local server.
  </Card>
  ...
  <Card title="Which models does BlackMushi use?" icon="microchip" href="/models-and-providers">
    See the current cloud routes, on-device models, and bring-your-own-provider behavior.
  </Card>
  <Card title="Can I use BlackMushi offline?" icon="wifi-slash" href="/offline">
...
3. Take rough notes in **Memos** while BlackMushi listens.
...
<Note>
  New to BlackMushi? Open the **Welcome to BlackMushi** note and click **Join & record**. It uses a private, prerecorded demo meeting.
</Note>
