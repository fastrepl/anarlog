...
You can use an existing paid plan for Intelligence without a separate API key. Open **Settings → Intelligence → Configure Providers** and connect **ChatGPT**, **Grok**, **GitHub Copilot**, or **Kimi Code**. After the connection finishes, select that provider under **Model being used**.
