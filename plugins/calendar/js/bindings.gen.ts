...
export type CalendarSyncEvent = { type: "statusChanged"; status: SyncStatus } | { type: "syncStarted" } | { type: "syncFinished"; data_changed: boolean } | { type: "syncFailed"; error: string }
