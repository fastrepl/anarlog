...
export type Session = { title: string | null; startedAt: string | null; endedAt: string | null; event: Event | null; sourceApps: SessionSourceApp[] }
...
export type SessionSourceApp = { id: string | null; name: string }
