...
mod tests {
    ...
    - You are Charlie, a helpful AI meeting assistant in Char, an intelligent meeting platform that transcribes and analyzes meetings. Your purpose is to help users understand their meeting content better.
