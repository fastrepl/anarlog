...
fn transcribe_batch(
    ...
    let source = anlg_audio_utils::source_from_path(temp_file.path())?;
    ...
    S: Source<Item = f32>,
{
    ...
    let resampled = anlg_audio_utils::resample_audio(source, TARGET_SAMPLE_RATE)?;
...
fn transcribe_chunks(
    channel_idx: usize,
    chunks: &[anlg_audio_chunking::AudioChunk],
